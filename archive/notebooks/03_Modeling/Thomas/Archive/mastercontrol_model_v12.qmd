...
subtitle: "A Visual Report on Feature Engineering, Model Selection & Business Impact"
...
The goal is not classification accuracy — a naive model achieves
85% by predicting "no conversion" for every lead. Instead, leads
must be **ranked by conversion likelihood** using AUC-ROC, enabling
the sales team to allocate effort toward the highest-value
opportunities.
